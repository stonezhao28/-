...
namespace UtilLib
{
    ...
    public class QuestionOperate
    {
        ...
        public bool AddQues(string QAName, string Question, string Qer)
        {
            ...
            {
                int ReturnValue = -1;
                db.Transact("insert into Sys_QA(QAName,Question,Qer,QuestionTime) values('" + QAName + "','" + Question + "','" + Qer + "','" + DateTime.Now+"')",
                    out ReturnValue);
        ...
        public bool UpdateQues(string Id, string QAName, string Question)
        {
            ...
            {
                int ReturnValue = -1;
                db.Transact("update Sys_QA set QAName='" + QAName + "',Question='" + Question + "',QuestionTime='" + DateTime.Now + "'where ID = '" + Id + " '",
                    out ReturnValue);
        ...
        public bool ReplyQues(string Id, string Aer, string Anwser)
        {
            ...
            {
                int ReturnValue = -1;
                db.Transact("update Sys_QA set Aer='" + Aer + "',Anwser='" + Anwser + "',AnwserTime='" + DateTime.Now + "'where ID = '" + Id + " '",
                    out ReturnValue);
