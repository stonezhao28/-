<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gouwu.aspx.cs" Inherits="Web.main_paymanager.program.gouwu1" %>
			...
			<div align="center">
							...
							<table class="tableclass2" cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    会员卡号：<asp:TextBox id="txtCardID2" runat="server" Width="100px" 
                                            AutoCompleteType="Disabled" autocomplete="off" onfocus="return clear()" TabIndex="1" onkeyup="enter(this)"></asp:TextBox>&nbsp;&nbsp;
                                    密码：<asp:TextBox id="txtPwd2" runat="server" Width="100px" 
                                            AutoCompleteType="Disabled" autocomplete="off"  TextMode="Password" 
                                            onfocus="return clear()" TabIndex="2" onkeyup="enter(this)"></asp:TextBox>
                                        &nbsp;&nbsp;
                                     ...
                                     <asp:Button ID="btnClear" runat="server" Text="清空" onclick="btnClear_Click" 
                                            OnClientClick= "return Clear()" TabIndex="3"  UseSubmitBehavior="false"/>&nbsp;&nbsp;
                                    <asp:button id="btnSave" runat="server"  text="充值" 
                            onclick="btnSave_Click" TabIndex="12" UseSubmitBehavior="false"></asp:button>&nbsp;&nbsp;
                                     <br />
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <asp:TextBox id="txtGoodsCode" Name="txtGoodsCode" runat="server" Width="100px" TabIndex="4" onkeyup="setInfo()" autocomplete="off"></asp:TextBox>
                                    ...
                                    数量：<asp:TextBox id="txtSum" runat="server" Width="100px" TabIndex="5" ></asp:TextBox>&nbsp;&nbsp;
                                        单价：<asp:TextBox id="TextAmt" runat="server" Width="100px" TabIndex="5" ></asp:TextBox>&nbsp;&nbsp;
                                     <asp:Button ID="Luru" runat="server" Text="录入" onclick="Luru_Click" TabIndex="6" UseSubmitBehavior="false"/>   
                                     <br /><br /><br />
               ...
               <div align="center">
					<asp:Button id="btnJiezhang" runat="server" Text="结  账" CssClass="button" 
                        onclick="btnJiezhang_Click" TabIndex="7" UseSubmitBehavior="false"></asp:Button>
			&nbsp;<br />
                    <br /><br />
				</div>
			</div>
